...
type Agent struct {
	...
	LastCheckin    *float32                           `json:"last_checkin,omitempty"`
...
// GetHostIdOk returns a tuple with the HostId field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetHubIdOk returns a tuple with the HubId field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetLastCheckinOk returns a tuple with the LastCheckin field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetArchOk returns a tuple with the Arch field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetExternalIpOk returns a tuple with the ExternalIp field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetInternalIpOk returns a tuple with the InternalIp field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetSystemInfoOk returns a tuple with the SystemInfo field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetConnectedOk returns a tuple with the Connected field value if set, zero value otherwise
// and a boolean to check if the value has been set.
